...
$(function () {
    ...
    if (-1 == iRet) {
        alert("您还未安装过插件，请下载WebComponentsKit.exe并安装！");
        window.open('/PSM/Monitor/codebase/WebComponentsKit.exe');
        return;
    }

    // 初始化插件参数及插入插件
    WebVideoCtrl.I_InitPlugin(900, 540, {
...
function autoClickLogin() {
    var szIP = $("#loginip").val(),
        ...
        szPassword = $("#password").val();
    $.ajax({
        url: '/PSM/MapAction!getMonitorInfo',
